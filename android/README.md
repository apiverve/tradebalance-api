...
```gradle
dependencies {
    implementation 'com.github.apiverve:tradebalance-api:1.1.13'
}
```
...
```java
import com.apiverve.tradebalance.TradeBalanceAPIClient;
import com.apiverve.tradebalance.APIResponse;
import com.apiverve.tradebalance.APIException;

// Initialize the client
TradeBalanceAPIClient client = new TradeBalanceAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("date", "2024-01");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/tradebalance](https://docs.apiverve.com/ref/tradebalance)
...
- **Documentation:** [https://docs.apiverve.com/ref/tradebalance](https://docs.apiverve.com/ref/tradebalance)
- **Issues:** [GitHub Issues](https://github.com/apiverve/tradebalance-api/issues)
