...
// Request contains the parameters for the Trade Balance API.
//
// Parameters:
...
// ResponseData contains the data returned by the Trade Balance API.
type ResponseData struct {
	YearMonth string `json:"yearMonth"`
	Year int `json:"year"`
	Month int `json:"month"`
	CustomsDuties int `json:"customsDuties"`
