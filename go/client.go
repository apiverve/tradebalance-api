// Package tradebalance provides a Go client for the Trade Balance API.
//
// For more information, visit: https://apiverve.com/marketplace/tradebalance?utm_source=go&utm_medium=readme
package tradebalance
...
const (
	baseURL        = "https://api.apiverve.com/v1/tradebalance"
	defaultTimeout = 30 * time.Second
)

// Client is the Trade Balance API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Trade Balance API client.
...
// Execute makes a request to the Trade Balance API with typed parameters.
//
...
//   - date: string - Optional date in YYYY-MM format for historical lookup. Omit for current data. [format: date]
