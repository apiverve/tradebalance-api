...
class tradebalanceWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/tradebalance');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/tradebalance';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"date":{"type":"string","required":false,"format":"date"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/tradebalance`);
        }
    }
...
module.exports = tradebalanceWrapper;
