...
namespace APIVerve.API.TradeBalance
{
    ...
    /// <summary>
    /// Client for the TradeBalance API
    /// </summary>
    public class TradeBalanceAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/tradebalance";
        ...
        public TradeBalanceAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TradeBalanceAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TradeBalanceAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TradeBalanceQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TradeBalanceQueryOptions options)
        {
        ...
        public ResponseObj Execute(TradeBalanceQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TradeBalanceQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TradeBalanceQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TradeBalanceQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TradeBalanceQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TradeBalanceQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TradeBalanceQueryOptions options)
        {
